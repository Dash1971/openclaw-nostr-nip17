...
export const nostrPlugin: ChannelPlugin<ResolvedNostrAccount> = createChatChannelPlugin({
  base: {
    ...
    meta: {
      ...
      docsLabel: "nostr",
      blurb: "Private DMs via Nostr relays (NIP-17)",
      order: 100,
    },
    capabilities: {
    ...
    // Standalone plugins can resolve a second physical copy of Zod through the host package.
    configSchema: buildChannelConfigSchema(NostrConfigSchema as never),
